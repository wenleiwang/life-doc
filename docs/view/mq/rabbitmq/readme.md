...
3. 保证消息的消费顺序
    ...
    * kafka
        ...
        - 写N个内存queue，然后N个线程分别消费一个内存queue即可
            ![](img/a81cc527e14773ad6b762a2f43dd6e5c.png)
...
![](img/1276d94a413f2dbd887b16931ccf3b53.png)
