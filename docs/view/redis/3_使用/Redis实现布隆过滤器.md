...
![](img/52a77a77b23305c37acc7e98debec3ff.png)
...
![](img/14de8ee1ff86783a1d623abfca93ca4e.png)
...
![](img/90b10c865c892a2bb40c3d98945558a5.png)
...
Redisson利用Redis实现了Java分布式的布隆过滤器。可以不用安装上面带布隆过滤器版本，正常安装Redis即可。
...
看下源码去：
点击add方法，一进去第一句`long[] hashes = hash(object);`果然，自己实现的。Redisson利用Redis实现了Java分布式的布隆过滤器。
...
使用Redis的布隆过滤器插件，这里需要用到安装的Redis布隆过滤器插件。
...
![](img/6ce0c1d9bbef6296b274f1ed4c5872f7.png)
...
![](img/e0978bc34e92d9b91d67aaac374ae7b3.png)
